...
4. The bundled exporter runs in the active Claude.ai tab.
...
2. Make sure this folder exists locally:
...
8. Pin the extension from the browser extensions menu if you want it visible in the toolbar.
9. Open a Claude.ai conversation.
10. Click the extension icon.
11. Click **Export Claude chat**.
...
8. Open a Claude.ai conversation and export.

## Install option 3: Chrome Web Store

This is planned.

After the extension is approved and published in the Chrome Web Store, the normal install flow will be:
